...
const std::vector<std::shared_ptr<cldnn::ImplementationManager>>& Registry<gemm>::get_implementations() {
    static const std::vector<std::shared_ptr<ImplementationManager>> impls = {
        OV_GPU_INSTANCE_ONEDNN(onednn::GemmImplementationManager),
        OV_GPU_INSTANCE_OCL(gemm, shape_types::static_shape),
        OV_GPU_INSTANCE_OCL(gemm, shape_types::dynamic_shape)
    };
