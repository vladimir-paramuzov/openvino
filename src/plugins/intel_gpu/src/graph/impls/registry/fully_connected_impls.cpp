...
const std::vector<std::shared_ptr<cldnn::ImplementationManager>>& Registry<fully_connected>::get_implementations() {
    static const std::vector<std::shared_ptr<ImplementationManager>> impls = {
        OV_GPU_INSTANCE_ONEDNN(onednn::FullyConnectedImplementationManager),
        OV_GPU_INSTANCE_OCL(fully_connected, shape_types::static_shape),
        OV_GPU_INSTANCE_OCL(fully_connected, shape_types::dynamic_shape)
    };
