...
struct ctc_loss_params : kernel_selector::base_params {
    ctc_loss_params() : base_params(kernel_selector::KernelType::CTC_LOSS) {}
...
protected:
    using kernel_params_t = ctc_loss_params;


    static kernel_params_t get_kernel_params(const kernel_impl_params& impl_param) {
        const auto& primitive = impl_param.typed_desc<ctc_loss>();
        auto params = get_default_params<ctc_loss_params>(impl_param);
