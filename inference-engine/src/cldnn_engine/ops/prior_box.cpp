...
void Program::CreatePriorBoxClusteredOp(cldnn::topology& topology, const std::shared_ptr<ngraph::Node>& node) {
...
void Program::CreatePriorBoxOp(cldnn::topology& topology, const std::shared_ptr<ngraph::Node>& node) {
