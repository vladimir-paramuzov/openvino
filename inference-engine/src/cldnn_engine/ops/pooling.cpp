...
void Program::CreateAvgPoolOp(cldnn::topology& topology, const std::shared_ptr<ngraph::Node>& node) {
...
void Program::CreateMaxPoolOp(cldnn::topology& topology, const std::shared_ptr<ngraph::Node>& node) {
